...
<html lang="en">
  <head>
    ...
    <title>Monique Bergevin - Upcoming</title>
  </head>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../fr/upcoming.php" disabled>Français</a>
      </li>
    </ul>
  </div>
</nav>
    ...
    <?php
      ...
      if (!isset($result)) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          if ($row["status"]) {
            $outputList .= '<li>' . $row['description'] . '</li>';  //Add Each Item to the List
          }
        }
