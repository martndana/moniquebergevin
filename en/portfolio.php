<?php
  ...
  switch ($filter) {
    case 1: {
      $categoryTitle = 'Available Paintings';
      $availableLinkClass .= 'currentList';
      break;
    }
    case 2: {
      $categoryTitle = 'Unavailable Paintings';
      $notAvailableLinkClass .= 'currentList';
      break;
    }
    default: {
      $categoryTitle = 'All Paintings';
      $allLinkClass = 'currentList';
      $filter = 0;
    }
  }

  $sql = 'SELECT `id`, `name`, `dimensions`, `medium`, `location`, `status` FROM `paintings`';
...
<html lang="en">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item" href="./portfolio.php?filter=2">Unavailable</a>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../fr/portfolio.php" disabled>Français</a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <div class="container-fluid mt-5 mb-5 project-font">
    <div class="row">
      <div class="col-2">
        <h3><a id="AllLink" class="btn-cursor <?php echo $allLinkClass ?>" href="./portfolio.php">Gallery</a></h3>
        <div class="mt-3">
          <!-- <div> <a id="AllLink" class="btn-cursor <?php echo $allLinkClass ?>" href="./portfolio.php">All</a></div> -->
          <div> <a id="availableLink" class="btn-cursor <?php echo $availableLinkClass ?>" href="./portfolio.php?filter=1">Available</a></div>
          <div> <a id="notAvailableLink"class="btn-cursor <?php echo $notAvailableLinkClass ?>" href="./portfolio.php?filter=2">Unavailable</a></div>
        </div>
      </div>
      <div class="col-10">
